...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: 'https://gharkamali.com/logo.png', width: 1200, height: 630, alt: 'GharKaMali Plant Care Plans' }],
  },
  twitter: {
    ...
    images: [{ url: 'https://gharkamali.com/logo.png', alt: 'GharKaMali Plant Care Plans' }],
  },
};
