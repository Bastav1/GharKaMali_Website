...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: 'https://gharkamali.com/og-image.jpg', width: 1200, height: 630, alt: 'GharKaMali Gardening Blog' }],
  },
  twitter: {
    ...
    images: [{ url: 'https://gharkamali.com/og-image.jpg', alt: 'GharKaMali Gardening Blog' }],
  },
};
