...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: 'https://gharkamali.com/og-image.jpg', width: 1200, height: 630, alt: 'Plantopedia — GharKaMali Plant Encyclopedia' }],
  },
  twitter: {
    ...
    images: [{ url: 'https://gharkamali.com/og-image.jpg', alt: 'Plantopedia — GharKaMali Plant Encyclopedia' }],
  },
};
